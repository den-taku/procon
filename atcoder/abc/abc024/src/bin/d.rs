...
fn main() {
    ...
    let cd = {
        let tmp = mod_inverse(
            {
                let tmp = (a * c % MOD - b * c % MOD + a * b % MOD) % MOD;
                if tmp < 0 {
                    tmp + MOD
                } else {
                    tmp
    ...
    let rd = {
        let tmp = mod_inverse(
            {
                let tmp = (a * b % MOD - b * c % MOD + a * c % MOD) % MOD;
                if tmp < 0 {
                    tmp + MOD
                } else {
                    tmp

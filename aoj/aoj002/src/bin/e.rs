// Maximum Flow (https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=GRL_6_A&lang=jp)
#![allow(dead_code)]
...
fn main() {
    ...
    for _ in 0..e {
        let e = read_line::<usize>();
        edges.push((e[0], e[1], e[2] as i64))
    }
    let mut dinic = dinic_library::Dinic::<i64>::new(v, &edges);
    println!("{}", dinic.max_flow(0, v - 1))
}
